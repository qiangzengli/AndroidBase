...
import com.cowain.base.contract.UnknownSourceContract
...
class InstallAppUtils(activity: ComponentActivity, private val apkPath: String) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            launcher = activityReference.get()?.registerForActivityResult(UnknownSourceContract()) {
                if (it) {
                    ...
                    activityReference.get()?.toast("未授予未知来源安装权限，无法安装")
                }
            }
        }
